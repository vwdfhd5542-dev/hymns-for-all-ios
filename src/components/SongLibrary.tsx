  ...
  return (
    <>
      <div className="relative rounded-xl">
        {/* Delete button - positioned to the right, outside the card */}
        <div
          className="absolute top-0 bottom-0 w-20 flex items-center justify-center bg-destructive rounded-xl overflow-hidden"
          style={{
            right: 0,
            clipPath: offsetX < 0 ? `inset(0 0 0 ${80 + offsetX}px)` : 'inset(0 0 0 100%)',
          }}
        >
